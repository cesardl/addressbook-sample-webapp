...
--
/*!50003 DROP FUNCTION IF EXISTS `sp_genera_codigo` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `sp_genera_codigo`() RETURNS varchar(4) CHARSET utf8
begin
declare generate, codigo  varchar(4);
...
until codigo is null
end repeat;

set retorno = concat_ws('-',codigo,generate);
return retorno;
end ;;
DELIMITER ;
...
-- Dump completed on 2026-07-09 20:41:35
